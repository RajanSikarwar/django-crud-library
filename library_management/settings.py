...
SECRET_KEY = "django-insecure-bgz@ww2s$ha+ybj3tm44ux%$-c4js8j6f8_t%i+jb3zo=&d6cw"
...
DATABASES = {
    'default': {
        ...
        'NAME': 'library_db',
        'USER': 'root', #change the name to your username
        'PASSWORD': 'rajan', #change the password to your password
        'HOST': 'localhost',
        'PORT': '3306',
    }
}
